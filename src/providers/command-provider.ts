import { Disposable, commands as vsCodeCommands, workspace as vsCodeWorkspace } from 'vscode';
...
export class CommandProvider implements Disposable {
     ...
     */
    public register(workspace: typeof vsCodeWorkspace, commands: typeof vsCodeCommands): void {
        const ignoreLineCommand = new IgnoreLineCommand(workspace);
        this.subscriptions.push(commands.registerCommand(IgnoreLineCommand.COMMAND, ignoreLineCommand.handle, ignoreLineCommand));
    }
}
