...
export function activate(context: ExtensionContext): void {
    ...
    const diagnosticCollection = languages.createDiagnosticCollection('PHP_CodeSniffer');
    ...
    const formatDocumentProvider = new FormatDocumentProvider(documentFormatter, diagnosticUpdater);
    context.subscriptions.push(languages.registerDocumentFormattingEditProvider({ language: 'php' }, formatDocumentProvider));
    context.subscriptions.push(languages.registerDocumentRangeFormattingEditProvider({ language: 'php' }, formatDocumentProvider));
