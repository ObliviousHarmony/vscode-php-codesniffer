...
## [3.1.0] - 2026-03-27
### Fixed
- The constructor now conditionally handles properties that changed in PHPCS 4.x while staying compatible with 3.x. (@brandondove)
- The phpCodeSniffer.standard configuration enum and descriptions no longer reference the removed MySource standard. (@brandondove)
