...
## [Unreleased]
### Fixed
- The constructor now conditionally handles properties that changed in PHPCS 4.x while staying compatible with 3.x.
- The phpCodeSniffer.standard configuration enum and descriptions no longer reference the removed MySource standard.
